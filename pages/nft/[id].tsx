      ...
      <div className="bg-gradient-to-br from-cyan-800 to-rose-500 lg:col-span-4">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
          ...
          <div className="space-y-2 p-5 text-center">
            <h1 className="text-4xl font-bold text-white">JIM Apes</h1>
            <h2 className="text-xl text-gray-300">
              A collection of JIM Apes who live & breathe React.
            </h2>
          </div>
        </div>
      </div>
      <div className="flex-1 flex-col p-12 lg:col-span-6">
        <header className="flex items-center justify-between">
          ...
          <button
            ...
            className="font rounded-full bg-rose-400 px-4 py-2 text-xs text-white lg:px-5 lg:py-3 lg:text-base"
          >
        ...
        <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:justify-center lg:space-y-0">
          ...
          <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">
            The JIM Ape Coding Club | NFT Drop
          </h1>
